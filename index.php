...
<body>
        ...
        <div>
            <div id="display1" class="md:mt-8 mt-4">
                ...
                <div class="grid grid-cols-1  gap-6">
                    <button id="btn-0" class="flex justify-center bg-green-500 hover:bg-green-500 tracking-wide text-white font-bold rounded-2xl w-3/4 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center">
                        Under 64
                    </button>
    ...
    <div id="display0" class="hidden hidden mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl container ">
        <div class="p-6 border-t-2 border-blue-500 mt-4 bg-gray-300 text-center shadow-xl">
            <h3 class="text-xl md:text-2xl font-bold text-red-500 mb-4">
    ...
    <div id="display4" class="hidden hidden mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl container ">
        <div class="p-6 border-t-2 border-blue-500 mt-4 bg-gray-300 text-center shadow-xl">
            ...
            <p class="text-xl md:text-2xl font-bold mb-4">
                Tap below to speak to an official agent to claim your benefit card! to say: Don't miss out - Speak to an official agent to claim your benefit card now.
            </p>
    ...
    <script>
        ...
        const dispaly0 = document.getElementById("display0");
